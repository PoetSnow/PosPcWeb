        ...
        success: function (data) {
            if (data.Success) {
               // layer.alert("添加成功", { title: "快点云Pos提示" });
                ...
                layer.alert("添加失败：" + data.Data, { title: "快点云Pos提示" });
            }
        },
        error: function (data) {
...
function setModel()
{
    ...
    if (name == "") {
        layer.alert("客人姓名不能为空", { title: "快点云Pos提示" });
        return false;
    }
    if (phone == "") {
        layer.alert("手机号不能为空", { title: "快点云Pos提示" });
        return false;
    }
    if (orderData == "") {
        layer.alert("预抵日期不能为空", { title: "快点云Pos提示" });
        return false;
    }
    if (tabNo == "") {
        layer.alert("请选择餐台", { title: "快点云Pos提示" });
        return false;
    }
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.Success) {
                ...
                layer.alert("修改失败：" + data.Data, { title: "快点云Pos提示" });
            }
        },
        error: function (data) {
