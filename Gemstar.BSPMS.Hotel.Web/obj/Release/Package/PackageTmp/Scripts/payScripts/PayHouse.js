...
PayHouse.prototype.PayInit = function () {
    ...
    var htmlStr = '<tr class="folioAddPayment"><td class="textright">房间号：</td><td class="textright"><input type="text" style="width:100%" class="k-textbox" id="roomNo" name="roomNo" onkeydown="getRommInfo(this,0)" onblur="getRommInfo(this,1)" /></td>' +
        '<td class="textright">客人名：</td><td class="textright"><input type="text" readonly="true" style="min-width:100%;background-color:rgb(245, 245, 245);" class="k-textbox" id="labelRoom"/></td></tr>' +
        '<tr class="folioAddPayment" style="color:red;"><td class="textright" colspan="2">允许挂房账：</td><td colspan="2"><span id="lblIsTransfer"></span></td></tr >' +
        ...
        '<tr class="folioAddPayment"><td class="textright">收银说明：</td><td><span id="lblCashRemark"></span></td><td>&nbsp;</td><td>&nbsp;</td ></tr>'+
        '<tr class="folioAddPayment"><td class="textright">备　注：</td><td colspan="3"><textarea class="k-textbox" id="lblRemark" style="width:100%;border:none;resize:none;" rows="1"></textarea></td></tr>';
