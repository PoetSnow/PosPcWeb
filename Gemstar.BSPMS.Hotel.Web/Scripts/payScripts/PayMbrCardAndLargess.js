function PayMbrCardAndLargess() {
    PayBase.apply(this);
}
PayMbrCardAndLargess.prototype = Object.create(PayBase.prototype);
PayMbrCardAndLargess.prototype.constructor = PayMbrCardAndLargess;
//初始化界面的方法
PayMbrCardAndLargess.prototype.PayInit = function () {
...
//提交前的检测方法
PayMbrCardAndLargess.prototype.PayCheck = function () {
    var cardNoValue = $("#folioMbrCardNo").val();
    if (!cardNoValue) {
        // jAlert("请输入会员卡卡号", "确定");
        layer.alert("请输入会员卡卡号", { title: "快点云Pos提示", skin: 'err' });
        return false;
    }
    return true;
};
...
//设置各自的支付参数方法
PayMbrCardAndLargess.prototype.PaySetPara = function (model) {
...
PayMbrCardAndLargess.prototype.PayAfterSave = function (model) {
