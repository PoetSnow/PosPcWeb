...
{
    public class PosRefeEditViewModel : BaseEditViewModel
    {
        [Display(Name = "Id")]
        ...
        [Display(Name = "所属营业点")]
        public string[] OpenInfos
        {
            get { return string.IsNullOrEmpty(OpenInfo) ? new string[] { } : OpenInfo.Split(','); }
            set { OpenInfos = value; }
        }
        ...
        [Display(Name = "楼面台号显示内容")]
        public string[] FloorShowDatas
        {
            get { return string.IsNullOrEmpty(FloorShowData) ? new string[] { } : FloorShowData.Split(','); }
            set { FloorShowDatas = value; }
        }
