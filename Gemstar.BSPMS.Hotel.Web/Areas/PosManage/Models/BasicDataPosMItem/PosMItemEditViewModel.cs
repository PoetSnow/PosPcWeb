...
namespace Gemstar.BSPMS.Hotel.Web.Areas.PosManage.Models.BasicDataPosMItem
{
    public class PosMItemEditViewModel : BaseEditViewModel
    {
        [Key]
        [Display(Name = "项目id")]
        ...
        //[Display(Name = "内部编码（捷云营业点外部代码）")]
        //public string CodeIn { get; set; }

        //[Display(Name = "外部代码：第三方软件的消费项目的编码")]
        //public string OutCodeNo { get; set; }

        //[Display(Name = "是否库存物品，如果是则它是当作消费项目的组成物品来定义，到时在组成定义里就可以显示此物品")]
        //public bool? IsCostItem { get; set; }

        [Display(Name = "消费项目显示：主要是设置消费项目、分类可以在电脑端、手机端程序上的显示设置。所以需要设置一个视图来定义相关的内容。目前可以知道的是PC端；手机端；IPAD端等。")]
