...
namespace Gemstar.BSPMS.Hotel.Services.PermanentRoomManage
{
    ...
    public interface IResService
    {
        ...
        void WriteLock(string hid, string regId, string cardNo, string seqId, string inputUser, string seqNo, string LockType);
        ...
        /// <returns></returns>
        JsonResultData ChangeRoom(ICurrentInfo currentInfo, string regId, string roomId, List<ResDetailPlanInfo> orderDetailPlans, string remark, string saveContinue, DateTime businessDate, string authorizationSaveContinue, decimal roomPrice, int? water, int? electric, int? gas);
        #endregion
        ...
        /// <returns></returns>
        JsonResultData AddRelation(string hid, string[] addRegIds, string toResId);
        ...
        /// <param name="toResId">要添加到的订单ID</param>
        /// <returns></returns>
        JsonResultData AddRelation(string hid, string addResId, string toResId);
        ...
        /// <returns></returns>
        JsonResultData GetRelationList(string hid, string notResId, string roomNo, string guestName, string guestMobile, string status, bool isPermanentRoom = false);
        ...
        /// <param name="businessDate">当前酒店营业日</param>
        /// <returns></returns>
        JsonResultData SaveRoomsAndCheckIn(string hid, string inputuser, string resId, List<KeyValuePairModel<string, List<KeyValuePairModel<string, string>>>> data, string saveContinue, DateTime businessDate, bool isEnvTest);
        ...
        /// <param name="regid"></param>
        /// <returns></returns>
        bool IsExistsPermanentRoomManageOrder(string hid, string regid);
        #endregion
        ...
        /// <param name="roomno">房号</param>
        /// <returns></returns>
        List<UpQueryRoomAutoChooseResult> GetPermanentRoomForRoomType(string hid, string regId, string roomTypeId, string floors, string features, string roomno, string arrDate, string depDate, string type);
        ...
        /// <returns></returns>
        JsonResultData GetPermanentRoomForRoomNo(string hid, string roomNo);
        ...
        /// <returns></returns>
        JsonResultData GetPermanentRoomPriceForRoomId(string hid, string roomid);
        #endregion
