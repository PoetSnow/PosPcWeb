...
{
    public interface IOperatorPlanService : ICRUDService<PercentagesPlanOperator>
    {
        /// <summary>
        /// 是否存在重复记录
        /// </summary>
        ...
        /// <returns></returns>
        bool Exists(string hid, List<Guid> OperatorId, DateTime planDate, string planSource, Guid? notId = null);
    }
}
