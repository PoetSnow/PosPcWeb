...
{
    /// <summary>
    /// up_pos_print_billOrderResult 查询结果
    /// </summary>
    public class up_pos_print_billOrderResult
    {
        ...
        public string 折前金额 { get; set; }
        public string 折后金额 { get; set; }
